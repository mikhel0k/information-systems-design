...
def parse_product(input_str: str) -> Dict[str, Any]:
...
def parse_delivery(input_str: str) -> Dict[str, Any]:
...
def parse_food(input_str: str) -> Dict[str, Any]:
...
def parse_drinks(input_str: str) -> Dict[str, Any]:
